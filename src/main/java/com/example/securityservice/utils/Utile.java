package com.example.securityservice.utils;
...
public class Utile {
    ...
    public static final String[] PUBLIC_URLS = { "/api/v1/security/login", "/api/v1/security/register","/swagger-ui.html","/swagger-ui/**","**"};
